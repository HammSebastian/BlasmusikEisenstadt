 ...
 * @since 7/28/25
 */
package com.sebastianhamm.Backend.gallery.api.controllers;
...
public class GalleryController {
    ...
    public ResponseEntity<ApiResponse<List<GalleryResponse>>> getAllGalleries() {
        ApiResponse<List<GalleryResponse>> response = galleryService.findAll();
    ...
    public ResponseEntity<ApiResponse<GalleryResponse>> getGallery(
        ...
        ApiResponse<GalleryResponse> response = galleryService.findById(id);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }
    ...
    public ResponseEntity<ApiResponse<GalleryResponse>> saveGallery(
        ...
        ApiResponse<GalleryResponse> response = galleryService.create(galleryRequest);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }
    ...
    public ResponseEntity<ApiResponse<GalleryResponse>> updateGallery(
            ...
            @Valid @RequestBody GalleryRequest galleryRequest) {
        ApiResponse<GalleryResponse> response = galleryService.update(id, galleryRequest);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }
    ...
    public ResponseEntity<Void> deleteGallery(
            ...
            @PathVariable Long id) {
        ApiResponse<String> response = galleryService.delete(id);
