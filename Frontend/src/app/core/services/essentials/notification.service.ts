...
import {NotificationModel, NotificationType} from '../../models/essentials/notentification.model';
...
export class NotificationService {
    ...
    private readonly notifications = signal<NotificationModel[]>([]);
    ...
    private addNotification(type: NotificationType, message: string, duration: number): void {
        ...
        const notification: NotificationModel = {id, type, message, duration};
